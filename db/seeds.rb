...
if Joke.all.length == 0
  ...
  Joke.create(category_id: 1, body: "In order to understand recursion you must first understand recursion.")
  Joke.create(category_id: 2, body: "A programmer is heading out to the grocery store, and is asked to 'get a gallon of milk, and if they have eggs, get a dozen.' So they return with 12 gallons of milk.")
end